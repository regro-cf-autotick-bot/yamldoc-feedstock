...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/yamldoc-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15197&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/yamldoc-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `yamldoc` can be installed with:

```
conda install yamldoc
```

It is possible to list all of the versions of `yamldoc` available on your platform with:
